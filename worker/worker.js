...
function rewriteAiWearMobileShareHtml(html) {
  return String(html || "")
    ...
    .replace("function lineShareUrl(url){return `https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(url||\"\")}`;}", "function lineShareUrl(url){return `https://social-plugins.line.me/lineit/share?url=${encodeURIComponent(url||\"\")}`;}\n    function lineFlexActionUrl(url){const value=String(url||\"\"); if(!value)return \"\"; return `${value}${value.includes(\"?\")?\"&\":\"?\"}lineShare=1`;}\n    function normalizeFlexImageUrl(url){const value=String(url||\"\"); if(!value)return \"\"; if(value.startsWith(location.origin+\"/assets/ai-wear/share/\")&&!/\\.(jpe?g|png|webp)(?:[?#]|$)/i.test(value))return value+\".jpg\"; return value;}")
    .replace("{type:\"button\",style:\"primary\",color:\"#06C755\",height:\"sm\",action:{type:\"uri\",label:\"我也要試戴\",uri:tryUrl}},{type:\"button\",style:\"link\",height:\"sm\",action:{type:\"uri\",label:\"查看分享頁\",uri:payload.shareUrl||tryUrl}}", "{type:\"button\",style:\"primary\",color:\"#06C755\",height:\"sm\",action:{type:\"uri\",label:\"我也要試戴\",uri:tryUrl}},{type:\"button\",style:\"secondary\",height:\"sm\",action:{type:\"uri\",label:\"分享\",uri:lineFlexActionUrl(payload.shareUrl||tryUrl)}},{type:\"button\",style:\"link\",height:\"sm\",action:{type:\"uri\",label:\"查看分享頁\",uri:payload.shareUrl||tryUrl}}")
