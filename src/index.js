...
import { registerAuthSessionShadowRoute } from './modules/system/auth-session.routes.js';
...
export { registerAuthSessionShadowRoute } from './modules/system/auth-session.routes.js';
